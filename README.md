...
Guide on how to deploy

1. Download XAMPP (Apache and mySQL needed within the app, no need to download separately)
2. After downloading, clone this repo and paste inside XAMPP folder -> htdocs -> folder containing our github repo
